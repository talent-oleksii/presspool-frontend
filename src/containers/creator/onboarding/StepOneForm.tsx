    ...
    <div className="max-w-[570px] m-auto flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-6 items-center">
        ...
        <span className="text-black text-[30px] -tracking-[0.9px] font-bold leading-normal">
          Welcome, we're going to setup your account
        </span>
      ...
      <div className="flex flex-col gap-5">
        <div
          className={`cursor-pointer flex items-center justify-between gap-4 border border-solid border-[#7F8182] rounded-[10px] py-3 px-5 ${
            AudienceSize.MASSIVE === audienceSize ? "bg-black" : ""
          }`}
        ...
        >
          <div className="flex flex-col gap-2 items-start">
            <span
              className={`text-[24px] ${
                AudienceSize.MASSIVE === audienceSize
                  ? "text-white"
                  : "text-black"
        ...
        <div
          className={`cursor-pointer flex items-center justify-between gap-4 border border-solid border-[#7F8182] rounded-[10px] py-3 px-5 ${
            AudienceSize.HUGE === audienceSize ? "bg-black" : ""
          }`}
        ...
        >
          <div className="flex flex-col gap-2 items-start">
            <span
              className={`text-[24px] ${
                AudienceSize.HUGE === audienceSize ? "text-white" : "text-black"
              } font-semibold -tracking-[0.72px]`}
            >
              Huge
            </span>
        ...
        <div
          className={`cursor-pointer flex items-center justify-between gap-4 border border-solid border-[#7F8182] rounded-[10px] py-3 px-5 ${
            AudienceSize.BIG === audienceSize ? "bg-black" : ""
          }`}
        ...
        >
          <div className="flex flex-col gap-2 items-start">
            <span
              className={`text-[24px] ${
                AudienceSize.BIG === audienceSize ? "text-white" : "text-black"
              } font-semibold -tracking-[0.72px]`}
            >
              Big
            </span>
        ...
        <div
          className={`cursor-pointer flex items-center justify-between gap-4 border border-solid border-[#7F8182] rounded-[10px] py-3 px-5 ${
            AudienceSize.GROWING === audienceSize ? "bg-black" : ""
          }`}
        ...
        >
          <div className="flex flex-col gap-2 items-start">
            <span
              className={`text-[24px] ${
                AudienceSize.GROWING === audienceSize
                  ? "text-white"
                  : "text-black"
              } font-semibold -tracking-[0.72px]`}
            >
