...
const Landing: FC = () => {
    ...
    return (
        <div className="pt-[90px] flex flex-col text-center items-center justify-center">
            ...
            {!isAuthenticated ?
                <p className='mt-[60px] font-[Inter] font-semibold text-sm'>Already have an account? Sign in <Link to="/login" className='text-purple underline'>here</Link></p> :
            ...
            <div className='mt-[20px] w-[536px] rounded-[20px] bg-[#1B1A1A] pt-[42px] px-[125px] pb-[6px]'>
                <p className='text-white text-lg font-semibold'>Discover Features</p>

                <div className='flex justify-center items-center mt-[15px]'>
                    <button className='bg-black text-gray-200 text-[7.8px] px-[8.87px] py-[8.3px] rounded-[4.5px] flex items-center mx-1 border-[.59px] border-white hover:border-[#7FFBAE]' onClick={() => setCurrent(0)}>
                    ...
                    <button className='bg-black text-gray-200 text-[7.8px] px-[8.87px] py-[8.3px] rounded-[4.5px] flex items-center mx-1 border-[.59px] border-white hover:border-[#7FFBAE]' onClick={() => setCurrent(1)}>
                    ...
                    <button className='bg-black text-gray-200 text-[7.8px] px-[8.87px] py-[8.3px] rounded-[4.5px] flex items-center mx-1 border-[.59px] border-white hover:border-[#7FFBAE]' onClick={() => setCurrent(2)}>
                        <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg" className='me-[3.5px]'>
