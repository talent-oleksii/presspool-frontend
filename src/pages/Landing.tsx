        ...
        <div className='flex items-center flex-col w-screen h-screen overflow-hidden pt-12 px-8'>
            <div className="flex flex-col text-center items-center justify-center">
                ...
                <h2 className="mt-2 font-[Inter] font-semibold text-[34px] mt-[12px] text-black mb-2 -tracking-[1.2px]">Welcome to the
                    ...
                    <span className='bg-[#43474a] text-main mx-2 rounded-full px-2 py-0'>future</span>
                    of AI marketing
                </h2>
                ...
                {!isAuthenticated ?
                    <p className='mt-5 font-[Inter] font-medium text-sm text-[#7F8182]'>Already have an account? Sign in <Link to="/login" className='text-black underline'>here</Link></p> :
            ...
            <div className='flex items-center flex-col mt-5 rounded-[10px] px-[15px] pt-[19px] pb-[14px] w-full px-8 shadow-md bg-[#fffdfd]'>
                ...
                <div className=''>
                    <div className='flex justify-center items-center mt-[15px]'>
                        <button className={`font-semibold text-lg justify-center px-12 py-2 min-w-[145px] -tracking-[.54px] rounded-[4.5px] items-center flex flex-col hover:border-main border-b-[1px] ${current === 0 ? 'text-black border-main' : 'text-[#525252] border-[#EDECF2]'}`} onClick={() => setCurrent(0)}>
                        ...
                        <button className={`font-semibold text-lg justify-center px-12 py-2 min-w-[145px] -tracking-[.54px] rounded-[4.5px] items-center flex flex-col hover:border-main border-b-[1px] ${current === 1 ? 'text-black border-main' : 'text-[#525252] border-[#EDECF2]'}`} onClick={() => setCurrent(1)}>
                        ...
                        <button className={`font-semibold text-lg justify-center px-12 py-2 min-w-[145px] -tracking-[.54px] rounded-[4.5px] items-center flex flex-col hover:border-main border-b-[1px] ${current === 2 ? 'text-black border-main' : 'text-[#525252] border-[#EDECF2]'}`} onClick={() => setCurrent(2)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none" className='mb-2'>
