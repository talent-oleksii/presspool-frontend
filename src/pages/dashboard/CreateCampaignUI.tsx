      ...
      <div className='col-span-1 text-left mt-36'>
        <div className='text-left me-2 rounded-md'>
          ...
          <button
            ...
            className={`overflow-hidden truncate px-2 text-sm 2xl:text-md py-2 flex items-center justify-center text-gray-800 text-left font-[Inter] w-[160px] border-dashed border-[1px] bg-white rounded mt-[7px] ${asterick && (!image || (image && image.length <= 0)) ? 'border-[red]' : 'border-gray-400'}`}
          >
            {file ? file.name :
              <>
