    ...
    >
        ...
        <div className="items-center flex mt-4 gap-12">
          ...
          <div className="flex gap-8 grid grid-cols-2 flex-1 pe-12">
            <div className="col-span-1">
              ...
              <input
                className="text-[18px] font-medium p-3 rounded-[9.5px] border-[1px] border-[#7f8182]/[.13]  text-[#7f8182] -tracking-[.54px] mt-2 bg-[#fbfbfb] w-full focus:ring-0 focus:border-main"
                value={fullName}
                disabled
              />
            </div>
      ...
      <div className="mt-4 p-6 bg-white rounded-[10px] shadow-md">
        ...
        <div className="items-center flex mt-4 gap-12  border-b-[1px] border-[#bcbcbc]">
          ...
          <div className="flex gap-8 grid grid-cols-2 flex-1 pe-12">
            <div className="col-span-1">
              ...
              <input
                className="text-[18px] font-medium p-3 rounded-[9.5px] border-[1px] border-[#7f8183]/[.13]  text-[#7f8182] -tracking-[.54px] mt-2 bg-[#fbfbfb] w-full focus:ring-0 focus:border-main"
                value={company}
                disabled
              />
            </div>
              ...
              <div className="mt-2">
                {cardList.map((item) => (
                  <div key={item.id}>
                    ...
                    <div className="bg-[#fbfbfb] text-base text-black border-[1px] border-[rgba(127, 129, 130, 0.13)] rounded-[10px] p-3 my-1.5">{`${item.brand.toUpperCase()} **** **** **** ${
                      item.last4
                    }`}</div>
                  </div>
                ))}
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button className="font-[Inter] font-medium -tracking-[.45px] text-[15px] flex items-center text-white bg-black rounded-[8px] px-4 py-2 gap-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button
            className="font-[Inter] font-medium -tracking-[.45px] text-[15px] flex items-center text-white bg-black rounded-[8px] px-4 py-2 gap-4"
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          {teamData.map((item) => (
            <div
              className="col-span-1 rounded-[12px] bg-white border-[1px] border-[#7f8182] shadow-md p-4"
              key={item.id}
            >
              <div className="border-b-[1px] border-[#ddd] pb-5">
                <p className="font-[Inter] text-[10px] font-normal -tracking-[.36px] text-[#a3a3a3]">
                  {item.role === "admin" ? "Administrator" : "Campaign Manager"}
                </p>
                <div className="flex items-center justify-between mt-2">
                  <div className="flex">
                    ...
                    <div className="text-left ms-2">
                      <p className="font-[Inter] text-[#43474a] text-sm font-medium -tracking-[.36px]">
                        {item.name}
                      </p>
                  ...
                  <button
                    className="flex text-[8px] text-white px-2 py-[2px] bg-[#E3392E] rounded-[3.25px] font-[Inter] items-center justify-center"
                    onClick={() =>
                      setTeamData(
              ...
              <div className="grid grid-cols-2 gap-4 mt-5">
                <div className="flex flex-col gap-3">
                  ...
                  <select
                    className="rounded-[5px] w-full border-[1px] border-black text-[10px] font-medium h-[25px] py-0"
                    value={item.role}
                    onChange={(e) => {
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      setTeamData(
                        teamData.map((team) => {
                          if (team.id === item.id)
                            return { ...team, campaign_list: e.join(",") };
                          return team;
                        })
                      );
                    }}
        ...
        <button
          className="mt-10 font-[Inter] text-sm font-semibold flex items-center px-8 py-2 bg-main rounded-[5px]"
