            ...
            <div className='mt-4 col-span-1 rounded-[12px] bg-white border-[1px] border-[#7f8182] shadow-md p-4' key={item.id}>
              <div className='border-b-[1px] border-[#ddd] pb-6'>
                ...
                <div className='flex items-center justify-between mt-2'>
                  ...
                  <button className='flex text-xs text-white px-2 py-[2px] bg-[#E3392E] rounded-[3.25px] font-[Inter] items-center justify-center' onClick={() => setTeamData(teamData.filter(team => team.id !== item.id))}>
