        ...
        <div>
          ...
          <div className="mt-6 flex">
            ...
            <div className="text-left">
              ...
              <p className="text-[#525252] font-[Inter] text-sm -tracking-[.24px] font-normal mt-2">
                Create stellar campaigns and manage their
                <br /> performance all in one centralized place
              </p>
            </div>
          </div>
          <div className="mt-6 flex">
            ...
            <div className="text-left">
              ...
              <p className="text-[#525252] font-[Inter] text-sm -tracking-[.24px] font-normal mt-2">
                Watch your impressions, clicks, and <br />
                conversions skyrocket as your solution <br />
                reaches targeted readers ready to buy.
              </p>
            </div>
          </div>
        </div>
