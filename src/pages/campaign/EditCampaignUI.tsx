      ...
      <div className='col-span-1 text-left mt-36'>
        <div className='text-left me-2 rounded-md'>
          ...
          <input
            ...
            className={`mt-1 w-full rounded-lg text-sm 2xl:text-md border-[1px] focus:ring-0 focus:border-[#6c63ff] py-2 px-3 ${asterick && pageUrl.length <= 0 ? 'border-[red]' : 'border-[#7F8182]'}`}
          />
