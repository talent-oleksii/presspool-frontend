...
const MainContent: FC = () => {
  ...
  const profileItems: MenuProps['items'] = [{
    ...
    label: (
      <Link to="/profile" className="font-[Inter] font-medium text-xs flex items-center">
        <svg viewBox="0 0 512 512" className="w-[12px] -ms-1 me-2" xmlns="http://www.w3.org/2000/svg">
    ...
    label: (
      <button className="font-[Inter] font-medium text-xs flex items-center" onClick={() => setShowAddTeamModal(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" fill="none" className="w-[12px] -ms-1 me-2">
          <path d="M4.33333 6H7.66667M6 4.33333V7.66667M1 6C1 6.65661 1.12933 7.30679 1.3806 7.91342C1.63188 8.52005 2.00017 9.07124 2.46447 9.53553C2.92876 9.99983 3.47996 10.3681 4.08658 10.6194C4.69321 10.8707 5.34339 11 6 11C6.65661 11 7.30679 10.8707 7.91342 10.6194C8.52005 10.3681 9.07124 9.99983 9.53553 9.53553C9.99983 9.07124 10.3681 8.52005 10.6194 7.91342C10.8707 7.30679 11 6.65661 11 6C11 4.67392 10.4732 3.40215 9.53553 2.46447C8.59785 1.52678 7.32608 1 6 1C4.67392 1 3.40215 1.52678 2.46447 2.46447C1.52678 3.40215 1 4.67392 1 6Z" stroke="black" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        Add a teammate
      </button>
    ),
    ...
    label: (
      <button className='font-[Inter] font-medium text-xs flex items-center' onClick={() => handleLogout()}>
        <img alt="Support" src={LogoutImage} className="w-[14px] me-2 -ms-1" />
        Log Out
      </button>
    ),
  ...
  return (
    <div className='min-h-screen w-full'>
      ...
      <div className='w-[210px] pl-2 pt-[50px] pb-2 flex flex-col h-full fixed justify-between'>
        <div>
          <div className='flex flex-col items-center justify-center'>

            <Link
              to="/new"
              className={`text-xs font-[Inter] flex items-center font-semibold text-left py-[18px] px-[12px] w-full bg-[#7FFBAE] rounded-[15px] my-3 text-black ${location.pathname.indexOf('new') > -1 ? 'ring-black ring-[1px]' : 'ring-0'}`}
            >
              <svg enableBackground="new 0 0 32 32" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-[18px] ms-1 me-2">
                <g><g id="Grid" /><g id="Meter" /><g id="Email" /><g id="Email_Notification" /><g id="Inbox" /><g id="Inbox_Notification" /><g id="List" /><g id="Grid_1_" /><g id="Add"><g><circle cx="16" cy="16" fill="none" r="14" stroke="#000000" strokeMiterlimit="10" /><g><line fill="none" stroke="#000000" strokeMiterlimit="10" x1="16" x2="16" y1="7.6" y2="24.4" /><line fill="none" stroke="#000000" strokeMiterlimit="10" x1="24.4" x2="7.6" y1="16" y2="16" /></g></g></g><g id="Minus" /><g id="Basket" /></g>
              </svg>
              Create New Campaign
            </Link>
            ...
            <div className="relative w-full">
              <Link className={`w-full text-left my-1.5 font-[Inter] text-xs font-medium rounded-[15px] px-3 py-2.5 flex items-center text-black hover:bg-white`}
                to="/campaign/all">
                <svg fill="none" height="15" viewBox="0 0 15 15" width="15" xmlns="http://www.w3.org/2000/svg" className="w-[16px] ms-1 me-2">
              ...
              <Link className={`w-full text-left my-1.5 font-[Inter] text-xs font-medium rounded-[15px] px-3 py-2.5 flex items-center text-black hover:bg-white`}
                to="/detail">
                <img alt="Support" src={CampaignImage} className="w-[16px] me-2 ms-1" />
                Campaigns
              </Link>
              <Link className={`w-full text-left my-1.5 font-[Inter] text-xs font-medium rounded-[15px] px-3 py-2.5 flex items-center text-black hover:bg-white`}
                to="/profile">
              ...
              <Link className={`w-full text-left my-1.5 font-[Inter] text-xs font-medium rounded-[15px] px-3 py-2.5 flex items-center text-black hover:bg-white`}
                to="/support">
                <img alt="Support" src={HelpImage} className="w-[16px] me-2 ms-1" />
                Support
              </Link>
              {
                (
