...
const MainContent: FC = () => {
  ...
  const profileItems: MenuProps['items'] = [{
    key: '1',
    label: (
      <Link to="/profile" className="font-[Inter] font-medium text-[10px] 2xl:text-xs flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[12px] h-[12px] 2xl:w-[16px] 2xl:h-[16px] me-1 -ms-1">
    ...
    key: '3',
    label: (
      <button className="font-[Inter] font-medium text-[10px] 2xl:text-xs flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[12px] h-[12px] 2xl:w-[16px] 2xl:h-[16px] me-1 -ms-1">
    ...
    key: '2',
    label: (
      <button className='font-[Inter] font-medium text-[10px] 2xl:text-xs flex items-center' onClick={() => handleLogout()}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[12px] h-[12px] 2xl:w-[16px] 2xl:h-[16px] me-1 -ms-1">
  ...
  const feedbackItems: MenuProps['items'] = [{
    key: '1',
    label: (
      <a href="https://forms.gle/T9Kc6JvaVhzwozYR8" className="font-[Inter] font-medium text-[10px] 2xl:text-xs flex items-center" target='_blank' rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[13px] h-[13px] 2xl:w-[18px] 2xl:h-[18px] -ms-1 me-1">
    ...
    key: '2',
    label: (
      <a href="https://forms.gle/j1HCrRcrGK9roPhGA" className="font-[Inter] font-medium text-[10px] 2xl:text-xs flex items-center" target='_blank' rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[13px] h-[13px] 2xl:w-[18px] 2xl:h-[18px] -ms-1 me-1">
      ...
      <div className="fixed px-[9px] py-[5px] w-full z-[7]">
        <div className="flex bg-[#fffdfd] rounded-full items-center px-[18px] py-[4.14px]">
          <Link to="/" className="text-left w-full">
            <img src={Logo} className='h-[15px]' alt="logo" />
          </Link>
          ...
          <div className="flex items-center">
            <Dropdown placement="bottomRight" menu={{ items: feedbackItems }}>
              <button className="flex font-[Inter] bg-[#C1FFD9] rounded-full px-[7px] h-[19px] text-[#57D386] text-xs whitespace-nowrap items-center">
                ...
                <span className="font-[Inter] text-[10px] 2xl:text-xs">Beta feedback</span>
              </button>
            </Dropdown>
              ...
              >
                <button className="flex justify-center items-center border-none p-0 font-[Inter] text-[11px]">
                  <Avatar className="bg-[#7FFBAE] text-black items-center justify-center flex h-[19px] w-[19px]" alt={getPlaceHolder()}>
                    <span className="text-[10px] 2xl:text-xs font-[Inter] font-medium">{getPlaceHolder()}</span>
                  </Avatar>
