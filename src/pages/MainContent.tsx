...
const MainContent: FC = () => {
  ...
  const profileItems: MenuProps['items'] = [{
    key: '1',
    label: (
      <Link to="/profile" className="font-[Inter] font-medium text-[8px] flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[8px] h-[8px] me-1">
    ...
    key: '3',
    label: (
      <button className="font-[Inter] font-medium text-[8px] flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[8px] h-[8px] me-1">
    ...
    key: '2',
    label: (
      <button className='font-[Inter] font-medium text-[8px] flex items-center' onClick={handleLogout}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[8px] h-[8px] me-1">
  ...
  const feedbackItems: MenuProps['items'] = [{
    key: '1',
    label: (
      <a href="https://forms.gle/T9Kc6JvaVhzwozYR8" className="font-[Inter] font-medium text-[8px] flex items-center" target='_blank' rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[11px] h-[11px] -ms-1 me-1">
    ...
    key: '2',
    label: (
      <a href="https://forms.gle/j1HCrRcrGK9roPhGA" className="font-[Inter] font-medium text-[8px] flex items-center" target='_blank' rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[11px] h-[11px] -ms-1 me-1">
  ...
  return (
    <div className='min-h-screen w-full'>
        ...
        <div className="flex bg-[#fffdfd] rounded-full items-center px-[18px] py-[4.14px]">
          ...
          <div className="flex items-center">
            <Dropdown placement="bottomRight" menu={{ items: feedbackItems }}>
              <button className="flex font-[Inter] bg-[#C1FFD9] rounded-full px-[7px] py-[4.2px] text-[#57D386] text-xs whitespace-nowrap items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="me-[3px] w-[11px] h-[11px]">
                ...
                <span className="font-[Inter] text-[8px]">Beta feedback</span>
              </button>
            </Dropdown>
            <div className="ms-[44px]">
              ...
              >
                <button className="flex justify-center items-center border-none p-0 font-[Inter] text-[11px]">
                  <Avatar className="bg-[#7FFBAE] text-black p-1 items-center justify-center flex h-[19px] w-[19px]" alt={getPlaceHolder()}>
                    <span className="text-[8px] font-[Inter] font-medium">{getPlaceHolder()}</span>
                  </Avatar>

                  <span className="font-[Inter] text-[8px] font-medium ms-[5px]">↓</span>
                </button>
              </Dropdown>
            </div>
          </div>
      ...
      <div className='min-w-[210px] pl-2 pt-[60px] pb-2 flex flex-col justify-between h-full fixed'>
        <div className='flex flex-col items-center justify-center'>

          <button
            className="text-xs 2xl:text-sm font-[Inter] flex items-center font-semibold text-left py-[18px] px-[12px] w-full bg-[#7FFBAE] rounded-[15px] my-4 text-black"
            onClick={() => setShowAddDialog(true)}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-[19px] h-[18px] 2xl:w-[20px] 2xl:h-[20px] me-2">
              <path d="M450.001-290.001h59.998v-160h160v-59.998h-160v-160h-59.998v160h-160v59.998h160v160Zm30.066 190q-78.836 0-148.204-29.92-69.369-29.92-120.682-81.21-51.314-51.291-81.247-120.629-29.933-69.337-29.933-148.173t29.92-148.204q29.92-69.369 81.21-120.682 51.291-51.314 120.629-81.247 69.337-29.933 148.173-29.933t148.204 29.92q69.369 29.92 120.682 81.21 51.314 51.291 81.247 120.629 29.933 69.337 29.933 148.173t-29.92 148.204q-29.92 69.369-81.21 120.682-51.291 51.314-120.629 81.247-69.337 29.933-148.173 29.933Z" />
            </svg>
            Create New Campaign
          </button>
