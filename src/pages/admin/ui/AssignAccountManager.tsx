            ...
            >
              ...
              >
                ...
                <div className="text-left w-full">
                  <p className="mt-8 text-xs font-[Inter] -tracking-[.48px] font-medium">
                    Company Name
                  </p>
                  <p className="mt-1 rounded-[10px] border-[1px] border-[#7f8182] w-full px-4 py-2 text-[#7f8182] text-xs font-medium -tracking-[.5px]">
                    {company}
                  </p>
                  <p className="mt-4 text-xs font-[Inter] -tracking-[.54px] font-medium">
                    Assigned Members
                  </p>
                  <Select
