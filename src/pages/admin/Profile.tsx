      ...
      {adminRole === "super_admin" && (
        <div className="mt-6 p-5 bg-white rounded-[10px] shadow-md">
          <div className="flex items-center justify-between">
            <h4 className="font-[Inter] text-primary text-xs font-semibold -tracking-[.6px]">
              My Team (Manage their Access Below)
            </h4>
          ...
          <div className="grid grid-cols-3 gap-6">
            {accountManagers.map((item: any) => (
              <div
                className="mt-4 col-span-1 rounded-[10px] bg-white border-[1px] border-[#7f8182] shadow-md p-4"
                key={item.id}
              >
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex">
                      ...
                      <div className="text-left ms-2">
                        <p className="font-[Inter] text-secondry1 text-xs font-medium -tracking-[.36px]">
                          {item.name}
                        </p>
                        <p className="font-[Inter] text-[#A3A3A3] text-xs -tracking-[.3px]">
                          {item.email}
                        </p>
                      </div>
                    </div>
          ...
          <button
            className="mt-8 font-[Inter] text-xs font-semibold flex items-center px-8 py-2 bg-main rounded-[10px]"
