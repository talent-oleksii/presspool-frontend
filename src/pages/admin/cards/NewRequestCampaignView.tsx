...
const NewRequestCampaignView = (item: any, panelStyle: any) => {
        ...
        <div className="flex flex-col w-full pl-[24px] pr-[72px] py-[20px] gap-3">
          <div className="flex items-center w-full gap-3">
            <p className="font-normal font-[Inter]">
              <span
                className={`bg-white ring-2 ring-secondry3 rounded-[10px] text-xs px-[12px] mt-[25px] py-[4px] font-normal`}
              >
                Added :{" "}
                {new Date(
...
export default NewRequestCampaignView;
