  ...
  return (
    <div className='text-left relative'>
      ...
      <div className='mt-4 flex'>
        <div className='border-[1px] border-[#7f8182] rounded-[10px] px-3 py-2 flex items-center'>
      ...
      <div className='mt-8'>
        <button
          className={`mr-4 border-[1px] rounded-[10px] border-[#7f8182] min-w-[150px] py-1.5 font-semibold ${currentTab === 'video' ? 'text-primary bg-[#7ffbae]' : 'text-[#7f8182] bg-transparent'}`}
          onClick={() => setCurrentTab('video')}
        >
          Videos
        </button>
        <button
          className={`mr-4 border-[1px] rounded-[10px] border-[#7f8182] min-w-[150px] py-1.5 font-semibold ${currentTab === 'document' ? 'text-primary bg-[#7ffbae]' : 'text-[#7f8182] bg-transparent'}`}
      ...
      <div className="mt-4 p-4 rounded-[10px] bg-white">
        <div className='flex items-center justify-between'>
          ...
          <button className='flex bg-black px-4 py-2 rounded-[10px] items-center text-white text-sm -tracking-[.45px]' onClick={() => setOpenNewModal(true)}>
              ...
              <div className="col-span-1 mb-4" key={item.id}>
                ...
                <div className='flex items-center mt-4 justify-between'>
                  ...
                  <button
                    ...
                    className='flex items-center text-white font-medium text-xs bg-[#e3392e] px-3 py-1.5 rounded-[10px]'
                  >
