                ...
                <div className='col-span-1'>
                  ...
                  <p className='text-lg font-[Inter] -tracking-[.48px] font-medium'>Visa Card</p>
                  {
                    ...
                    <div>
                      ...
                      {
                        accountManager &&
                        <div className='rounded-[10px] bg-[#fbfbfb] border-[1px] border-[#7f8183]/[.13] my-2 px-2 py-1 flex items-center justify-between'>
                          <p className='text-[#43474a] font-[Inter] -tracking-[.5px] font-medium text-sm'>{accountManager.name}</p>
                          <span className='text-xs font-[Inter] text-white  px-2 py-[1px] rounded-lg bg-[#e3392e]'>
