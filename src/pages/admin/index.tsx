      ...
      label: (
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 -960 960 960"
            className="w-[16px] h-[16px] me-2 -ms-1"
          >
        ...
        <div>
          <div className="flex flex-col items-center justify-center">
            {adminRole === "super_admin" && (
              <button
                className={`text-xs font-[Inter] flex items-center font-semibold text-left py-[18px] px-[12px] w-full bg-[#7FFBAE] rounded-[10px] my-4 text-primary ${
            ...
            <div className="relative w-full">
              <Link
                className={`w-full text-left my-1.5 font-[Inter] text-xs rounded-[10px] px-3 py-2.5 flex items-center font-medium text-primary hover:bg-white`}
                to="/admin/dashboard"
              >
                <svg
                  fill="none"
              ...
              {(location.pathname.indexOf("dashboard") > -1 ||
                ...
                <div
                  className={`absolute ${
                    adminRole === "super_admin" ? "h-[20%]" : "h-[25%]"
                  } bg-white w-full rounded-[10px] shadow-sm -z-[1] transition-all duration-500 transform ${getOffsetBack()} `}
                />
              )}
            </div>
          </div>
