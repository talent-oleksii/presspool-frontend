    ...
    <div className="min-h-full w-full flex">
      <div className="text-left flex-1">
        ...
        <div className='mt-4 flex'>
          <div className="rounded-lg border-[1px] border-[#7f8182] gap-[15px] px-3 py-2 flex items-center">
        ...
        <div className="mt-4 flex">
          {
            ...
            <div className='bg-white rounded-[15px] w-full mb-2'>
              {accountManagers.map((item: any) => (
                <div className='mt-4 col-span-1 rounded-[12px] border-[1px] border-[#7f8182] shadow-md p-4' key={item.id}>
