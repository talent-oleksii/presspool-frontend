        ...
        <div className='w-full flex-col flex items-center justify-center'>
          {type && type === 'success' &&
            <div className='flex flex-col items-center justify-center'>
              ...
              <h2 className='mt-[12px] font-[Inter] text-primary text-[20px] font-semibold'>{title.length > 0 ? title : 'Success!'}</h2>
            </div>
          }
          {
            type && type === 'error' &&
            <div className='flex flex-col items-center justify-center'>
              ...
              <h2 className='mt-[12px] font-[Inter] text-primary text-[20px] font-semibold text-center'>{title.length > 0 ? title : 'Something Wrong'}</h2>
            </div>
          }
